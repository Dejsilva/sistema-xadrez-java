...
public class UI {
	...
	// https://stackoverflow.com/questions/5762491/how-to-print-color-in-console-using-system-out-println
		...
		public static XadrezPosicao leituraPosicao(Scanner sc) {
			try{
	...
	public static void printPartida(PartidaXadrez partidaXadrez, List<PecaXadrez> capturar) {
		printTabuleiro(partidaXadrez.getPecas());
		System.out.println();
		printCapturaPecas(capturar);
		System.out.println();
	...
	public static void printTabuleiro(PecaXadrez[][] pecas, boolean[][] possiveisMoves) {
		for(int i = 0;i < pecas.length; i++) {
			System.out.print(8 - i + " ");
			for(int j = 0;j < pecas.length;j++) {
				printPeca(pecas[i][j], possiveisMoves[i][j]);
			}
			System.out.println();
		}
		System.out.println("  a b c d e f g h");
